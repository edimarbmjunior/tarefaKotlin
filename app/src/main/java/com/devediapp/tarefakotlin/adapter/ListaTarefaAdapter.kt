...
class ListaTarefaAdapter (val listaTarefas: List<TarefaEntity>, val listenerFragment: OnListaTarefaFragmentInteractionListener) : RecyclerView.Adapter<TarefaViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TarefaViewHolder {
        val context = parent.context
        val inflater = LayoutInflater.from(context)
        val view = inflater.inflate(R.layout.row_tarefa_lista, parent, false)

        return TarefaViewHolder(view, context!!, listenerFragment)
    }
